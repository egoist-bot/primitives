...
const MenuContentImpl = React.forwardRef<MenuContentImplElement, MenuContentImplProps>(
  (props: ScopedProps<MenuContentImplProps>, forwardedRef) => {
    ...
    const [ownerDocument, setOwnerDocument] = React.useState<typeof document|null>(null)
    const getWindow = () => ownerDocument?.defaultView
    ...
    React.useEffect(() => {
      return () => getWindow()?.clearTimeout(timerRef.current);
    }, [ownerDocument]);

    React.useEffect(() => {
      setOwnerDocument(contentRef.current?.ownerDocument || document)
    }, [])
                ...
                <PopperPrimitive.Content
                  ...
                  onBlur={composeEventHandlers(props.onBlur, (event) => {
                    ...
                    if (!event.currentTarget.contains(event.target)) {
                      getWindow()?.clearTimeout(timerRef.current);
                      searchRef.current = '';
                    }
                  })}
